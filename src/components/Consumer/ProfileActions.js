...
// Reducer
const defaultState = {data: null, ongoingRequest: false, lastError: null, lastSuccess: null, credentials: null };
const profileReducer = (state = defaultState, action) => {
  switch (action.type) {
    case MAKE_REQUEST:
      return {...state, data: null, ongoingRequest: true, lastSuccess: null, lastError: null};
    case REQUEST_SUCCESS:
      return {...state, data: action.data, ongoingRequest: false, lastSuccess: action.data, lastError: null, credentials: action.data};
    case REQUEST_ERROR:
      return {...state, data: null, ongoingRequest: false, lastError: action.data, lastSuccess: null};
    case RESET:
      return {...defaultState};
