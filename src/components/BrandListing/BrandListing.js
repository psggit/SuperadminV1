...
class BrandListing extends Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
...
const decoratedConnectedComponent = commonDecorator(BrandListing);// connect(mapStateToProps)(CommonDecorator);
