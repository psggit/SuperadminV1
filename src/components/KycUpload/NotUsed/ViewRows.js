    ...
    if (!(isSingleRow)) {
      viewButton = (
        <button className="btn btn-xs btn-default" onClick={() => {
          ...
          dispatch(routeActions.push('/hadmin/consumer/kycfunctions/upload_kyc/upload_kyc_profile/' + row.id));
        }}>View</button>);
    }
    ...
    */
    ...
    if (!(isSingleRow)) {
      editButton = (
        <button className="btn btn-xs btn-default" onClick={() => {
          dispatch({type: E_SET_EDITITEM, oldItem: row, pkClause});
          dispatch(routeActions.push('/consumer/' + curTableName + '/edit'));
        }}>Edit</button>);
    }
    if (!(isSingleRow)) {
      cloneButton = (
        <button className="btn btn-xs btn-default" onClick={() => {
          ...
          dispatch(routeActions.push('/consumer/' + curTableName + '/insert'));
        }}>Clone</button>);
    }
    if (!(isSingleRow)) {
      deleteButton = (
