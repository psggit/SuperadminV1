...
const MAKE_REQUEST = 'KycUploadViews/MAKE_REQUEST';
const REQUEST_SUCCESS = 'KycUploadViews/REQUEST_SUCCESS';
const REQUEST_ERROR = 'KycUploadViews/REQUEST_ERROR';
const RESET = 'KycUploadViews/RESET';
...
const kycuploadviewReducer = (state = defaultState, action) => {
  switch (action.type) {
    case MAKE_REQUEST:
