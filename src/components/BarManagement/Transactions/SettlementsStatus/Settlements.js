...
import { getAllTransactionData, getTransactionData } from './SettlementsAction';
...
class Settlements extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
  ...
  render() {
    const styles = require('./Settlements.scss');
    ...
    return (
        <div className={styles.container}>
          ...
          <PaginationWrapper
            ...
            showMax="5"
            parentUrl="/hadmin/bar_management/retailer_reports"
          />
        </div>
      );
  }
...
const decoratedConnectedComponent = commonDecorator(Settlements);// connect(mapStateToProps)(CommonDecorator);
