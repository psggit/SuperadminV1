            ...
            <div className={styles.customer_transaction_links}>
                ...
                <div className = {styles.box_wrapper}>
                    <div className={styles.squarecontent}>
                        <div>
                            <span>
                                <Link to={'/hadmin/brands_offers_and_promos/create_sku_ad'}>Create SKU Ad</Link>
                            </span>
                        </div>
                    </div>
                </div>
                <div className = {styles.box_wrapper}>
                    <div className={styles.squarecontent}>
                        <div>
                            <span>
                                <Link to={'/hadmin/brands_offers_and_promos/create_promo_ad'}>Create Promo Ad</Link>
                            </span>
                        </div>
                    </div>
                </div>
                <div className = {styles.box_wrapper}>
                    <div className={styles.squarecontent}>
                        <div>
                            <span>
                                <Link to={'/hadmin/brands_offers_and_promos/create_bar_ad'}>Create Bar Ad</Link>
                            </span>
                        </div>
                    </div>
                </div>
