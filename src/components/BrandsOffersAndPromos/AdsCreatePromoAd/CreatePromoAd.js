...
import { updateList, fetchStates, fetchCampaigns, citiesViewHandler, IMAGE_UPLOAD_SUCCESS, IMAGE_UPLOAD_ERROR, IMAGE_CANCEL} from './CreateAdPromoActions';
...
import { RESET } from './CreateAdPromoActions';
/*
...
class CreatePromoAd extends Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
...
const mapStateToProps = (state) => {
  return {...state.page_data, ...state.createPromoAd_data};
};

const decoratedConnectedComponent = commonDecorator(CreatePromoAd);// connect(mapStateToProps)(CommonDecorator);
