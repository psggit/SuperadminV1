...
import BrandManagersList from './AdsList';
...
class Ads extends Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
...
const decoratedConnectedComponent = commonDecorator(Ads);// connect(mapStateToProps)(CommonDecorator);
