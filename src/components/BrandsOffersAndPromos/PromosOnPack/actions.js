...
const ON_FAILED = '@PromosOnPack/ON_FAILED';
const ON_LOADING = '@PromosOnPack/ON_LOADING';
const ON_SUCCESS = '@PromosOnPack/ON_SUCCESS';

const DO_NOTHING = '@PromosOnPack/DO_NOTHING';

const VALUE_CHANGE = '@PromosOnPack/VALUE_CHANGE';

const ADD_PROMO = '@PromosOnPack/ADD_PROMO';
const REMOVE_PROMO = '@PromosOnPack/REMOVE_PROMO';
const EDIT_PROMO = '@PromosOnPack/EDIT_PROMO';

const PROMO_CHANGE = '@PromosOnPack/PROMO_CHANGE';
const RESET_DATA = '@PromosOnPack/RESET_DATA';

const INIT_COMPANY = '@PromosOnPack/INIT_COMPANY';
const INIT_BRAND_MANAGERS = '@PromosOnPack/INIT_BRAND_MANAGERS';
