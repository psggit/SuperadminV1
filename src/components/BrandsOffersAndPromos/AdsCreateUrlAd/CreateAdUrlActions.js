...
import { defaultcreateUrlAdData} from '../../Common/Actions/DefaultState';
...
const insertCityMap = (adId) => {
  return (dispatch, state) => {
    ...
    const adImageUrl = Endpoints.db + '/table/ad_url_city/insert';
    const data = {};
...
const insertAdData = (bmId, imgUrl, adInfo) => {
  return (dispatch) => {
    ...
    const adUrl = Endpoints.db + '/table/ad_url/insert';
