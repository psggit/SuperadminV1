...
class ViewSkuAd extends Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
...
const mapStateToProps = (state) => {
  return {...state.page_data, ...state.viewSkuAd_data};
};

const decoratedConnectedComponent = commonDecorator(ViewSkuAd);// connect(mapStateToProps)(CommonDecorator);
