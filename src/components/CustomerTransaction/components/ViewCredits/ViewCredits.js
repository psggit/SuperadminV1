...
import { getAllTransactionData, getTransactionData } from './ViewCreditsAction';
...
const decoratedConnectedComponent = commonDecorator(ViewCredits);// connect(mapStateToProps)(CommonDecorator);
