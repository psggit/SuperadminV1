              ...
              <ul>
              {
                viewedCity.retailers.map((retailer, index) => {
                  return (
                    <li key={index}>
                      <label>
                        <input type="checkbox" data-retailer-id={retailer.retailer_id} type="checkbox" checked={ viewedCity.selected_retailers[retailer.retailer_id] ? true : false } onClick={ onRetailerCheck }/>
                        { retailer.org_name }
                      </label>
                    </li>
                  );
