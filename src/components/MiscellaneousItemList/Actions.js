...
const BAR_SKU_FETCHED = '@miscellaneous_item/BAR_SKU_FETCHED';
...
const getBarSkusCount = ( filterObj, isSearched ) => {
  return (dispatch, getState) => {
    ...
    const url = Endpoints.db + '/table/' + 'miscellaneous_item' + '/count';
    const genOptions = {
      method: 'POST',
...
const toggleBarSkuStatus = ( id, isActive, currPage, pricingId, barId ) => {
  return ( dispatch, getState ) => {
    ...
    const invUrl = Endpoints.db + '/table/miscellaneous_item/update';
