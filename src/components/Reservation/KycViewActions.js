...
const MAKE_REQUEST = 'KycView/MAKE_REQUEST';
const REQUEST_SUCCESS = 'KycView/REQUEST_SUCCESS';
const REQUEST_ERROR = 'KycView/REQUEST_ERROR';
const RESET = 'KycView/RESET';
...
const kycviewReducer = (state = defaultState, action) => {
  switch (action.type) {
    case MAKE_REQUEST:
