...
import { getAllTransactionData, getTransactionData } from './RedemptionsAction';
...
class Redemptions extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
  ...
  render() {
    const styles = require('./Redemptions.scss');
    ...
    return (
        <div className={styles.container}>
          ...
          <PaginationWrapper
            ...
            showMax="5"
            parentUrl="/hadmin/retailer_management/redemptions"
          />
        </div>
      );
  }
...
const decoratedConnectedComponent = commonDecorator(Redemptions);// connect(mapStateToProps)(CommonDecorator);
