...
const loginReducer = (state = defaultState, action) => {
  switch (action.type) {
    ...
    case REQUEST_SUCCESS:
      const priority = {'admin': 12, 'opadmin': 6, 'opdataadmin': 7, 'opdataentry': 8, 'customer_support': 9, 'product_team': 10, 'qa_team': 11, 'support_read_only': 3, 'user': 1, 'dataentry': 4, 'dataadmin': 5, 'support_person': 2 };
