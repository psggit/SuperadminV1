...
class ConsumerManualCodes extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
    ...
    this.breadCrumbs.push({
      title: 'Consumer Manual Debit and Credit codes',
      sequence: 2,
      link: '#'
    });
  }
  ...
  render() {
    const styles = require('./ConsumerManualCodes.scss');
...
const decoratedConnectedComponent = commonDecorator(ConsumerManualCodes);// connect(mapStateToProps)(CommonDecorator);
