...
class ConsumerIssueCodes extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
  ...
  render() {
    const styles = require('./ConsumerIssueCodes.scss');
...
const decoratedConnectedComponent = commonDecorator(ConsumerIssueCodes);// connect(mapStateToProps)(CommonDecorator);
