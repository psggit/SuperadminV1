...
class ConsumerDeviceAccountCodes extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
    ...
    this.breadCrumbs.push({
      title: 'Consumer Device Account Codes',
      sequence: 2,
      link: '#'
    });
  }
  ...
  render() {
    const styles = require('./ConsumerDeviceAccountCodes.scss');
...
ConsumerDeviceAccountCodes.propTypes = {
...
const decoratedConnectedComponent = commonDecorator(ConsumerDeviceAccountCodes);// connect(mapStateToProps)(CommonDecorator);
