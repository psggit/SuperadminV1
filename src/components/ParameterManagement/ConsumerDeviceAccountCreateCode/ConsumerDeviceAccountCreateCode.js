...
class ConsumerDeviceAccountCreateCode extends React.Component {
  constructor() {
    super();
  ...
  render() {
    const styles = require('./ConsumerDeviceAccountCreateCode.scss');
...
export default ConsumerDeviceAccountCreateCode;
