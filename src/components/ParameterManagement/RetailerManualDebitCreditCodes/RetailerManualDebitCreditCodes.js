...
class RetailerManualDebitCreditCodes extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
    ...
    this.breadCrumbs.push({
      title: 'Retailer Manual Debit and Credit Codes',
      sequence: 2,
      link: '#'
    });
  }
  ...
  render() {
    const styles = require('./RetailerManualDebitCreditCodes.scss');
...
RetailerManualDebitCreditCodes.propTypes = {
...
const decoratedConnectedComponent = commonDecorator(RetailerManualDebitCreditCodes);// connect(mapStateToProps)(CommonDecorator);
