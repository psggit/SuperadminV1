...
class RetailerManualCreateCode extends React.Component {
  constructor() {
    super();
  ...
  render() {
    const styles = require('./RetailerManualCreateCode.scss');
    ...
    return (
      <div className={styles.container}>
        ...
        <div className = {styles.disable_device_wrapper}>
          ...
          <DisableInformation label = "Type" val = "Credit" />
...
export default RetailerManualCreateCode;
