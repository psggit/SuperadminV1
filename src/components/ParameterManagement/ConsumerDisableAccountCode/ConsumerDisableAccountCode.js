...
class ConsumerDisableAccountCode extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
  ...
  render() {
    const styles = require('./ConsumerDisableAccountCode.scss');
...
ConsumerDisableAccountCode.propTypes = {
...
const decoratedConnectedComponent = commonDecorator(ConsumerDisableAccountCode);// connect(mapStateToProps)(CommonDecorator);
