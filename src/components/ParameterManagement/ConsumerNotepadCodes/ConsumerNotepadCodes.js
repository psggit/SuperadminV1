...
class ConsumerNotepadCodes extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
  ...
  render() {
    const styles = require('./ConsumerNotepadCodes.scss');
...
ConsumerNotepadCodes.propTypes = {
...
const decoratedConnectedComponent = commonDecorator(ConsumerNotepadCodes);// connect(mapStateToProps)(CommonDecorator);
