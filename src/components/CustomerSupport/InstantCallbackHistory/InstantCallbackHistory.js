...
import { getAllBrandData, getBrandData } from './InstantCallbackHistoryAction';
...
class InstantCallbackHistory extends React.Component { // eslint-disable-line no-unused-vars
  constructor() {
    super();
    ...
    this.breadCrumbs.push({
      title: 'Instant Callback History',
      sequence: 3,
      link: '#'
    });
  }
  ...
  render() {
    const styles = require('./InstantCallbackHistory.scss');
...
InstantCallbackHistory.propTypes = {
...
const decoratedConnectedComponent = commonDecorator(InstantCallbackHistory);// connect(mapStateToProps)(CommonDecorator);
