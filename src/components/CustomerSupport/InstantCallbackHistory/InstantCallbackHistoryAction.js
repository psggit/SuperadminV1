...
const getBrandCount = () => {
  return (dispatch) => {
    ...
    const url = Endpoints.db + '/table/' + 'request_callback' + '/count';
    const options = {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      credentials: globalCookiePolicy,
...
const InstantCallbackHistoryReducer = (state = defaultBrandState, action) => {
  let region = {};
  let selectedCity = {};
  let regionCity = {};
  switch (action.type) {
...
export default InstantCallbackHistoryReducer;
